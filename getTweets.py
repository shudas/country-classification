...
#geo_index = 16  #16 and 17 are gold
...
api = twitter.Api(consumer_key=KEYS[key_index][0], consumer_secret=KEYS[key_index][1], access_token_key=KEYS[key_index][2], access_token_secret=KEYS[key_index][3])
