...
##    to specify the number of tweets returned per user, set count
    utweets = api.GetUserTimeline(user_id=uid, count=500, include_rts=False, exclude_replies=True, trim_user=True)
